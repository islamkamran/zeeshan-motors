...
class VehicleInterior(TimestampMixin, Base):
    ...
    ambient_lighting_mood_lighting = Column(Boolean, default=False)
    digital_instrument_cluster = Column(Boolean, default=False)
    head_up_display = Column(Boolean, default=False)
    wireless_charging_pad = Column(Boolean, default=False)
    multi_zone_climate_control = Column(Boolean, default=False)
    premium_sound_system = Column(Boolean, default=False)
    wood_interior = Column(Boolean, default=False)
    aluminum_tri_interior = Column(Boolean, default=False)
    ventilated_seats = Column(Boolean, default=False)
    panoramic_sunroof = Column(Boolean, default=False)
    rear_entertainment_screens = Column(Boolean, default=False)
    power_adjustable_steering_column = Column(Boolean, default=False)
    memory_seats = Column(Boolean, default=False)
    alcantara_carbon_fiber_trim = Column(Boolean, default=False)
    alarm = Column(Boolean, default=False)
    cooled_rear_seat = Column(Boolean, default=False)
    wireless_smartphone_charger = Column(Boolean, default=False)
    usb_type_c_port = Column(Boolean, default=False)
    usb_20_port = Column(Boolean, default=False)
    v12_power_outlet = Column(Boolean, default=False)
    rear_charging_ports = Column(Boolean, default=False)
...
class VehicleSafety(TimestampMixin, Base):
    ...
    degree_360_camera = Column(Boolean, default=False)
    front_rear_parking_sensors = Column(Boolean, default=False)
    automatic_emergency_braking = Column(Boolean, default=False)
    pedestrian_detection = Column(Boolean, default=False)
    cross_traffic_alert_rear = Column(Boolean, default=False)
    driver_attention_warning = Column(Boolean, default=False)
    night_vision_assist = Column(Boolean, default=False)
    tire_pressure_monitoring_system = Column(Boolean, default=False)
    collision_mitigation_system = Column(Boolean, default=False)
    isofix_child_seat_mounts = Column(Boolean, default=False)
    adaptive_lighting = Column(Boolean, default=False)
    performance_kit_tuned = Column(Boolean, default=False)
    parking_button = Column(Boolean, default=False)
    manual_handbrake = Column(Boolean, default=False)
    electronic_parking_brake_auto_hold = Column(Boolean, default=False)
...
class VehicleExterior(TimestampMixin, Base):
    ...
    matrix_led_laser_headlights = Column(Boolean, default=False)
    automatic_headlight_on_off = Column(Boolean, default=False)
    power_tailgate = Column(Boolean, default=False)
    roof_rails_roof_rack = Column(Boolean, default=False)
    dual_exhaust_pipes = Column(Boolean, default=False)
    sport_exhaust = Column(Boolean, default=False)
    rear_spoiler = Column(Boolean, default=False)
    led_dlrs_daytime_running_lights = Column(Boolean, default=False)
    auto_folding_side_mirrors = Column(Boolean, default=False)
    frameless_doors = Column(Boolean, default=False)
    charging_port = Column(Boolean, default=False)
    soft_close_doors = Column(Boolean, default=False)
    illuminated_logo_welcome_lights = Column(Boolean, default=False)
    rain_sensing_wipers = Column(Boolean, default=False)
    Performance_tyres = Column(Boolean, default=False)
    side_mirrors_indicators  = Column(Boolean, default=False)
    sports_suspension = Column(Boolean, default=False)
    premium_paint = Column(Boolean, default=False)
    air_deflector = Column(Boolean, default=False)
...
class VehicleComfortConvenience(TimestampMixin, Base):
    ...
    wireless_apple_carplay_android_auto = Column(Boolean, default=False)
    voice_control_system = Column(Boolean, default=False)
    gesture_control = Column(Boolean, default=False)
    remote_engine_start = Column(Boolean, default=False)
    auto_dimming_rearview_mirror = Column(Boolean, default=False)
    driver_seat_massager = Column(Boolean, default=False)
    rear_window_sunshade_manual = Column(Boolean, default=False)
    rear_window_sunshade_electric = Column(Boolean, default=False)
    air_purifier_ionizer = Column(Boolean, default=False)
    cabin_noise_cancellation = Column(Boolean, default=False)
    smart_climate_control_ai_sensing = Column(Boolean, default=False)
    ota_updates_over_the_air_software = Column(Boolean, default=False)
    sports_drive_mode = Column(Boolean, default=False)
    comfort_drive_mode = Column(Boolean, default=False)
    snow_drive_mode = Column(Boolean, default=False)
    intelligent_parking_assist_auto_park = Column(Boolean, default=False)
    digital_key_smartphone = Column(Boolean, default=False)
    electric_rear_seat_recline = Column(Boolean, default=False)
    navigation_system = Column(Boolean, default=False)
    power_locks = Column(Boolean, default=False)
    tinted_windows = Column(Boolean, default=False)
    rear_tv_screens = Column(Boolean, default=False)
    cd_dvd_player = Column(Boolean, default=False)
    mp3_interface = Column(Boolean, default=False)
