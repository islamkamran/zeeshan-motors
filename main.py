...
from app.api import bids_auctions, db_testing, vehicles, vehicle_by_id, display_all_vehicles,vehicle_price, containers, customers,roles_crud, invoice, search_inventory, feedback, count_users,profit_loss,sold_item_count,vehicle_inventry_report
...
app.include_router(bids_auctions.router)
